...
<body>
<marquee><h2><b style="background:gray; color:black;"> DEPARTMENT:{{$user->Department}}</h2></b></marquee>
<header>
<center><h3><b>Online Notice board</b></h3></center>
...
<div class="container2">
  <div class="row">
    <div class="col-sm-2">
    <div class="btn-group">
  <image src="news.jpg" width="50px"/>&nbsp <button type="button" style='width:100px;height:35px;' class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown">
    Categories</button>
    <div class="dropdown-menu">
...
<p style='font-style:italic;color:red;'><image src="co.jpg" width="80px"/>&nbsp
  <b>*Be updated about COVID-19 with AarogyaSethu App</b>&nbsp<image src="ar.jpg" width="80px"/>&nbsp</p>
</div>
<div class='col-sm-2'>
